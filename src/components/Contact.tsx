    ...
    <section id="contact" className="py-16 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <motion.a
          ...
          className="group inline-flex items-center gap-2 px-8 py-3.5 bg-accent cta-btn rounded-full font-medium text-sm hover:shadow-lg hover:shadow-accent/20 transition-all duration-300 mb-10"
        >
          <Mail size={16} />
          Discuss a Role
